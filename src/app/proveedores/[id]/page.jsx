  ...
  return (
    <section>
      <div className="flex gap-4 items-center mb-4">
        <BackButton />
        <h1 className="grow text-2xl pb-2 border-b-2 border-blue-400">
          Proveedor {id}
        </h1>
      </div>

      <Suspense
        fallback={<SquareLoader color="#cad5e2" cssOverride={{}} size={150} />}
      >
        <Proveedor promesaProveedor={promesaProveedor} />{" "}
        {/*  Pasamos promesa */}
      </Suspense>

      <Suspense
        fallback={<p className="text-blue-500 italic">Cargando prueba...</p>}
      >
